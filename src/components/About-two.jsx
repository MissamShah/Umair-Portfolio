                            ...
                            <div className="content flex flex-col gap-8 h-full">
                                ...
                                <ul className="flex flex-wrap gap-3 justify-center lg:justify-start">
                                        {[
                                            ...
                                            <>
                                                <li key={index} className="w-30 h-30 flex items-center justify-center bg-[#212428] shadow-card rounded-lg transition-transform duration-300 hover:-translate-y-1">
